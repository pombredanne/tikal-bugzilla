...
@Bugzilla::Constants::EXPORT = qw(
	...
	FIELD_NOT_MANDATORY
	FIELD_MANDATORY_ALWAYS
	FIELD_MANDATORY_FOR_NEW
	FIELD_MANDATORY_FOR_EXISTING
	FIELD_MANDATORY_FOR_RESOLVED_FIXED
	FIELD_MANDATORY_FOR_REOPENED
    ...
    VERSION_STATUS_UNRELEASED
    VERSION_STATUS_RELEASED
    VERSION_STATUS_ARCHIVED
    VERSION_STATUS_FINAL
    
    USER_HOMEPAGE_TYPE_NONE
    USER_HOMEPAGE_TYPE_SYSTEM_BROWSE
    USER_HOMEPAGE_TYPE_USER_NEW_ISSUES
    USER_HOMEPAGE_TYPE_USER_OPEN_ISSUES
    USER_HOMEPAGE_TYPE_USER_SAVED_SEARCH
...
use constant CMT_ATTACH_TO => 5;
use constant CMT_DETACH_FROM => 6;
...
# Issue Types - used for lists
use constant ISSUE_TYPES_ALL => 0;
use constant ISSUE_TYPES_REGULAR => 1;
use constant ISSUE_TYPES_SUBTASK => 2;
use constant ISSUE_TYPES_PARENT => 3;
...
use constant FIELD_NOT_MANDATORY => 0;
use constant FIELD_MANDATORY_ALWAYS => 1;
use constant FIELD_MANDATORY_FOR_NEW => 2;
use constant FIELD_MANDATORY_FOR_EXISTING => 3;
use constant FIELD_MANDATORY_FOR_RESOLVED_FIXED => 4;
use constant FIELD_MANDATORY_FOR_REOPENED => 5;
...
# The longest entity name allowed.
use constant MAX_ENTITY_SIZE => 64;

# The longest milestone name allowed.
use constant MAX_MILESTONE_SIZE => 20;

# The longest version name allowed.
use constant MAX_VERSION_SIZE => 20;
...
# Versions statuses
use constant VERSION_STATUS_UNRELEASED => 0;
use constant VERSION_STATUS_RELEASED => 1;
use constant VERSION_STATUS_ARCHIVED => 2;
use constant VERSION_STATUS_FINAL => 3;

# User homepage boxes types
use constant USER_HOMEPAGE_TYPE_NONE => 0;
use constant USER_HOMEPAGE_TYPE_SYSTEM_BROWSE => 1;
use constant USER_HOMEPAGE_TYPE_USER_NEW_ISSUES => 2;
use constant USER_HOMEPAGE_TYPE_USER_OPEN_ISSUES => 3;
use constant USER_HOMEPAGE_TYPE_USER_SAVED_SEARCH => 4;
