...
sub field {
    ...
    $cache->{"field_$class"} ||= new Bugzilla::Field({ name => 'component' });
...
=head1 SYNOPSIS
    ...
    my $invisible  		   = $component->invisible;
...
=item C<product()>
 ...
 Description: Invisible indicator of the component.

 Params:      none.

 Returns:     The Invisible indicator of the component. 
...
=item C<set_cc_list(\@cc_list)>
 ...
 Description: Changes the invisible indicator of the component.

 Params:      $new_invisible - new invisible indicator of the component (boolean).
