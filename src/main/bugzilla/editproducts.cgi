...
$vars->{"entity_field"} = new Bugzilla::Field({'name' => "entity"});
...
if ($action eq 'new') {
    ...
    my $product =
      Bugzilla::Product->create({classification   => $classification_name,
                                 ...
                                 showonhomepage	  => scalar $cgi->param('showonhomepage'),
                                 viewvc_root	  => scalar $cgi->param('viewvc_root'),
                                 default_entity	  => scalar $cgi->param('default_entity'),
...
if ($action eq 'update') {
    ...
    $product->set_showonhomepage(scalar $cgi->param('showonhomepage'));
    $product->set_viewvc_root(scalar $cgi->param('viewvc_root'));
 	$product->set_default_entity(scalar $cgi->param('default_entity'));
